...
@Component
@Slf4j
public class RedisSecondServiceImpl implements RedisSecondService {

    @Resource
    private RedisTemplate<String,Object> redisTemplateSecond;
    ...
    public Result<Boolean> lPush(String key, Object value) {
        try {
            redisTemplateSecond.opsForList().leftPush(key, value);
    ...
    public Object rpop(String key) {
        try {
            return redisTemplateSecond.opsForList().rightPop(key);
        } catch (Exception ex) {
    ...
    public Object brpop(String key, long timeout, TimeUnit timeUnit) {
        try {
            return redisTemplateSecond.opsForList().rightPop(key, timeout, timeUnit);
        } catch (Exception ex) {
    ...
    public Object brpop(String key) {
        try {
            return redisTemplateSecond.opsForList().rightPop(key, 30, TimeUnit.SECONDS);
        } catch (Exception ex) {
    ...
    public List<Object> lrange(String key, long start, long end) {
        try {
            return redisTemplateSecond.opsForList().range(key, start, end);
        } catch (Exception ex) {
    ...
    public Result<Boolean> expire(final String key, final long timeout, final TimeUnit unit) {
        try {
            Boolean ret = redisTemplateSecond.expire(key, timeout, unit);
    ...
    public Result<Boolean> del(final String key) {
        try {
            Boolean ret = redisTemplateSecond.delete(key);
            return (ret != null && ret)?Result.success():Result.fail();
        } catch (Exception ex) {
    ...
    public long del(final Collection<String> keys) {
        try {
            Long ret = redisTemplateSecond.delete(keys);
    ...
    public void set(final String key, final Object value, final long timeout) {
        try {
            redisTemplateSecond.opsForValue().set(key, value, timeout, TimeUnit.SECONDS);
        } catch (Exception ex) {
            log.error("set异常：{}，key={}，value={}", ex.getMessage(), key, value);
        }
    }
    ...
    public Object get(final String key) {
        try {
            return redisTemplateSecond.opsForValue().get(key);
        } catch (Exception ex) {
    ...
    public void hPut(final String key, final String hKey, final Object value) {
        try {
            redisTemplateSecond.opsForHash().put(key, hKey, value);
        } catch (Exception ex) {
    ...
    public void hPutAll(final String key, final Map<String, Object> values) {
        try {
            redisTemplateSecond.opsForHash().putAll(key, values);
        } catch (Exception ex) {
    ...
    public Object hGet(final String key, final String hKey) {
        try {
            return redisTemplateSecond.opsForHash().get(key, hKey);
        } catch (Exception ex) {
    ...
    public List<Object> hMultiGet(final String key, final Collection<Object> hKeys) {
        try {
            return redisTemplateSecond.opsForHash().multiGet(key, hKeys);
        } catch (Exception ex) {
    ...
    public long sSet(final String key, final Object... values) {
        Long count = null;
        try {
            count = redisTemplateSecond.opsForSet().add(key, values);
        } catch (Exception ex) {
    ...
    public long sDel(final String key, final Object... values) {
        Long count = null;
        try {
            count = redisTemplateSecond.opsForSet().remove(key, values);
        } catch (Exception ex) {
    ...
    public long lPushAll(final String key, final Collection<Object> values) {
        Long count = null;
        try {
            count = redisTemplateSecond.opsForList().rightPushAll(key, values);
        } catch (Exception ex) {
    ...
    public Set<String> getKeys(String prefix) {
        try {
            return redisTemplateSecond.keys(prefix + "*");
        } catch (Exception ex) {
